...
from reservationsapp.views import get_passager_details, create_passager, view_passagers, edit_passager, delete_passager, signup, update_profile, account, collaborator
